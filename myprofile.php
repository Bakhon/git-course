    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-auto py-2 pr-0">
                <a href="first.html" rel="nofollow">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8 col-lg-7 col-xl-6">
                    <div class="bg-black-50 rounded-xl px-4 py-3 text-white text-center text-md-left shadow">
                        ...
                        <h1>Иван Иванов<span id="w1" class="ml-2 icon-pro">PRO</span></h1>
                        ...
                        <div class="mt-2">
                            <span class="text-warning pr-2">
                             ...
                             <a href="#reviews" rel="nofollow" class="small text-light">2 отзыв(a,ов)</a>
                        </div>

                        <div class="mt-2">
                            <svg class="mr-2 i is-map-marker-alt"><use xlink:href="#s-map-marker-alt" /></use></svg>Нур-Султан                       
                        </div>
...
<section class="container pt-5">
    <div class="row mb-4">
        <div class="col-lg-8">
            ...
            <div>
                <p>Предлагаю качественную работу в сфере строительства.Опыт работы на рынке строительных услуг 11 лет. Составляю сметы и помогаю в закупке материала. Сотрудничаю с дизайнером. Выполняю ремонт любой сложности, работаю сам и с бригадой в зависимости от объекта. Гарантирую быструю и качественную работу, выполненную в соответствии со всеми требованиями и стандартами.Будут вопросы задавайте всегда рад помочь советом.</p>            
            </div>
            <!-- О мастере end -->
            ...
            <div class="mt-5 border mb-5 pt-3 pb-4 px-1 rounded-xl shadow-sm">
                ...
                <div class="font-weight-bold text-center mt-3 mb-2">Основная</div>
                    <ul id="w2" class="ml-4 flex-column nav">
                        <li class="nav-item"><svg class="text-body mr-1 i is-caret-right"><use xlink:href="#s-caret-right" /></use></svg>Ремонт квартиры или комнаты</a></li>
    ...
    <div class="container">
        ...
        <div class="row justify-content-md-center">
            <div class="col-sm-auto ml-auto pt-2 pr-5">
                ...
                <div class="d-block mb-3 hidden-phone h4 font-weight-normal align-top">
                    ...
                    <div class="d-inline-block">
                        (701) xxx xxxx<br>
                        <a class="view-phone text-muted small" href="#" data-type="1" data-id="5000">Показать номер</a>
                    </div>
                </div>   
            ...
            <div class="col-sm-6">               
                    ...
                    <span class="text-body align-middle">Нур-Султан</span>
                </a>                                                                            
            </div>
        </div>
